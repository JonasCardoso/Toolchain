...
enum opt_code
{
  ...
  OPT_mfpu_ = 1170,                          /* -mfpu= */
  /* OPT_mhard_float = 1171, */              /* -mhard-float */
  OPT_mlittle_endian = 1172,                 /* -mlittle-endian */
  OPT_mlong_calls = 1173,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1174,               /* -mneon-for-64bits */
  ...
  OPT_mpure_code = 1179,                     /* -mpure-code */
